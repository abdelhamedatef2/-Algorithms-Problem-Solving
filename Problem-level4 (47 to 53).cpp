...
int main()
{
	...
	cout << "Today is " << DayShortName(DayOfWeekOrder(Date1))<<","<< Date1.Day << "/" << Date1.Month << "/" << Date1.Year << endl;
	cout << "\n\nis it end of week ? \n";
	isEndOfWeek(Date1)? cout << "Yes it's end of a week.\n\n": cout << "No not end of a week.\n\n";
	cout << "is it a weekend ? \n";
	isWeekEnd(Date1) ? cout << "Yes it's weekend.\n\n" : cout << "No not a weekend\n";
	cout << "\n\nis it a Business Day ? \n";
	isBusinessDay(Date1) ? cout << "Yes it's Business Day.\n\n" : cout << "No not a Business Day\n";
	cout << "Days until the end of week is : " << DaysUntilEndOfWeek(Date1) << " Day(s).\n";
